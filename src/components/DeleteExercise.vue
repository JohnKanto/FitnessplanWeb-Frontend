<template>
  <div v-if="isVisible" class="popup" style="z-index: 10;">
    <div style="width: 100%; height: 81px; text-align: center; color: black; font-size: 50px; font-weight: 700; word-wrap: break-word">DeleteExercise</div>
...
export default {
  ...
  methods: {
    ...
    onDelete () {
      ...
      fetch('http://localhost:8080/api/v1/exercise/' + this.ID, requestOptions)
